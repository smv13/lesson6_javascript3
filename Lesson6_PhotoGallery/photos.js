...
if (figureCount === 3) {
for (var i = 1; i < 4; i++) {
filename = "images/IMG_0" + photoOrder[i] + "sm.jpg"; currentFig = document.getElementsByTagName("img")[i - 1]; currentFig.src = filename;
}//end of loop
} else{
for (var i = 0; i < 5; i++) {
...
//declare variable for document element with id of leftarrow in the html document var leftarrow = document.getElementById("leftarrow");
//add an event handler to the specified document element (leftarrow)
//the leftArrow() function will executed when user clicks the left navigation arrow leftarrow.addEventListener("click", leftArrow, false);
//declare variable for document element with id of rightarrow in the html document var rightarrow = document.getElementById("rightarrow");
//add an event handler to the specified document element (rightarrow)
//the rightArrow() function will executed when user clicks the right navigation arrow rightarrow.addEventListener("click", rightArrow, false);
